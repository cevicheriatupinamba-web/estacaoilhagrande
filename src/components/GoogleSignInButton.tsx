...
const GoogleSignInButton = ({ label = "Continuar com Google", className }: Props) => {
  ...
  return (
    <Button
      ...
      onClick={handleClick}
      disabled={loading}
      className={`w-full gap-2 border-2 ${className ?? ""}`}
    >
      <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
        ...
        <path fill="#34A853" d="M9 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.258c-.806.54-1.836.86-3.048.86-2.344 0-4.328-1.583-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18z"/>
