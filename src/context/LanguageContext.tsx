...
const dictionaries: Record<Lang, Dict> = {
  pt: {
    ...
    "nav.logout": "Sair",
    "home.badge": "Guia oficial — Ilha Grande / RJ",
    "home.title1": "O portal premium",
    "home.title2": "da Ilha Grande",
    "home.subtitle": "Pousadas, restaurantes, passeios e experiências curadas em um só lugar. Descubra o paraíso como um local.",
    "home.searchPlaceholder": "Busque praias, pousadas, passeios...",
    "home.search": "Buscar",
  ...
  en: {
    ...
    "nav.signup": "Sign up",
    "nav.logout": "Log out",
    "home.badge": "Official guide — Ilha Grande / RJ",
    "home.title1": "The premium portal",
    "home.title2": "to Ilha Grande",
    "home.subtitle": "Inns, restaurants, tours and curated experiences in one place. Discover paradise like a local.",
    "home.searchPlaceholder": "Search beaches, inns, tours...",
    "home.search": "Search",
  ...
  es: {
    ...
    "nav.logout": "Salir",
    "home.badge": "Guía oficial — Ilha Grande / RJ",
    "home.title1": "El portal premium",
    "home.title2": "de Ilha Grande",
    "home.subtitle": "Posadas, restaurantes, paseos y experiencias seleccionadas en un solo lugar. Descubra el paraíso como un local.",
    "home.searchPlaceholder": "Busque playas, posadas, paseos...",
    "home.search": "Buscar",
    "home.portalKicker": "Portal Ilha Grande",
